    ...
    <form action="{{ route('recipe.store') }}" method="POST" class="w-10/12 p-4 mx-auto bg-white rounded" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-2 rounded border border-gray-500 my-4">
            ...
            <div class="col-span-1 p-4">
                <input type="text" placeholder="レシピ名" value="{{ old('title') }}" name="title" class="border border-gray-300 p-2 mb-4 w-full rounded">
                <textarea name="description" placeholder="レシピの説明" class="border-gray-300 p-2 mb-4 w-full rounded">{{ old('description') }}</textarea>
